...
::web::json::value odata_json_writer_minimal::serialize(std::vector<std::shared_ptr<odata_parameter>> parameters)
{
	if (parameters.empty())
	{
...
void odata_json_writer_minimal::handle_serialize_odata_parameter(::utility::stringstream_t& ss, const std::shared_ptr<::odata::core::odata_parameter>& parameter, ::utility::char_t mark, ::utility::char_t separator)
{
...
void odata_json_writer_minimal::handle_serialize_odata_properties(::utility::stringstream_t& ss, const odata_property_map& properties)
{
...
void odata_json_writer_minimal::handle_serialize_primitive_value(::utility::stringstream_t& ss, 
...
void odata_json_writer_minimal::handle_serialize_enum_value(::utility::stringstream_t& ss, const std::shared_ptr<odata_enum_value>& p_value)
{
	if (!p_value)
	{
		return ;
...
void odata_json_writer_minimal::handle_serialize_collection_value(::utility::stringstream_t& ss, const std::shared_ptr<odata_collection_value>& p_value)
{
	if (!p_value)
	{
		return ;
...
bool odata_json_writer_minimal::is_type_serializable(const std::shared_ptr<edm_named_type>& property_type)
{
	if (property_type)
	{
