...
IMPLEMENT_PRIMITIVE_PROPERTY_IN_COMPLEX_MAPPING(City, country, Country, ::utility::string_t);
...
BEGIN_PROPERTY_IN_COMPLEX_MAPPING(City)
    ON_PROPERTY_IN_COMPLEX_MAPPING(City, country)
...
BEGIN_SERIALIZE_PROPERTY_IN_COMPLEX_MAPPING(City)
    ON_SERIALIZE_PROPERTY_IN_COMPLEX_MAPPING(City, country)
