...
{
public:
	odata_contex_url_parser(std::shared_ptr<::odata::edm::edm_model> model, const ::utility::string_t& service_root_url) 
		: m_model(model), m_service_root_url(service_root_url)
	{
	}

	ODATACPP_API std::shared_ptr<::odata::edm::edm_named_type> get_payload_content_type(const ::utility::string_t& context_url);
